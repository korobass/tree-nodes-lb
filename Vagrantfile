...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  servers.each do |server_name, server_ip|
      ...
      server_config.vm.box_url = "http://files.vagrantup.com/precise32.box"
      server_config.vm.box = "preciese32.box"
      ...
      # provisiong puppet global manifests
...
#	when "web1","web2" then 
  ...
  # the file preciese32.box.pp in the manifests_path directory.
  #
